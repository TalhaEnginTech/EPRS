...
ActiveRecord::Schema.define(version: 2021_11_12_093304) do
  ...
  create_table "questions", force: :cascade do |t|
    ...
    t.bigint "review_forms_id"
    t.index ["review_forms_id"], name: "index_questions_on_review_forms_id"
  end
  ...
  add_foreign_key "questions", "review_forms", column: "review_forms_id"
